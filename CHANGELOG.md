...
- Update GATK to `v4.7.0.0`

## [2.3.0] - 2026-07-20

### Added

- Add support for `minibwa` aligner source
...
[2.1.0]: https://github.com/TheBoutrosLab/pipeline-recalibrate-BAM/compare/v2.0.0...v2.1.0
[2.2.0]: https://github.com/TheBoutrosLab/pipeline-recalibrate-BAM/compare/v2.1.0...v2.2.0
